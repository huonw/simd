...
extern "platform-intrinsic" {
    ...
    fn x86_mm256_adds_epu16(x: i16x16, y: i16x16) -> i16x16;
    fn x86_mm256_adds_epu8(x: i8x32, y: i8x32) -> i8x32;
    fn x86_mm256_avg_epu16(x: i16x16, y: i16x16) -> i16x16;
    fn x86_mm256_avg_epu8(x: i8x32, y: i8x32) -> i8x32;
    ...
    fn x86_mm256_max_epu16(x: i16x16, y: i16x16) -> i16x16;
    fn x86_mm256_max_epu32(x: i32x8, y: i32x8) -> i32x8;
    fn x86_mm256_max_epu8(x: i8x32, y: i8x32) -> i8x32;
    ...
    fn x86_mm256_min_epu16(x: i16x16, y: i16x16) -> i16x16;
    fn x86_mm256_min_epu32(x: i32x8, y: i32x8) -> i32x8;
    fn x86_mm256_min_epu8(x: i8x32, y: i8x32) -> i8x32;
    fn x86_mm256_mul_epi32(x: i32x8, y: i32x8) -> i64x4;
    fn x86_mm256_mul_epu32(x: i32x8, y: i32x8) -> i64x4;
    fn x86_mm256_mulhi_epi16(x: i8x32, y: i8x32) -> i8x32;
    fn x86_mm256_mulhi_epu16(x: i8x32, y: i8x32) -> i8x32;
    ...
    fn x86_mm256_packus_epi16(x: i16x16, y: i16x16) -> i8x32;
    fn x86_mm256_packus_epi32(x: i32x8, y: i32x8) -> i16x16;
    fn x86_mm256_permutevar8x32_epi32(x: i32x8, y: i32x8) -> i32x8;
    fn x86_mm256_permutevar8x32_ps(x: f32x8, y: i32x8) -> i32x8;
    fn x86_mm256_sad_epu8(x: i8x32, y: i8x32) -> i64x4;
    ...
    fn x86_mm256_subs_epu16(x: i16x16, y: i16x16) -> i16x16;
    fn x86_mm256_subs_epu8(x: i8x32, y: i8x32) -> i8x32;
